        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 pb-8 border-b border-slate-200">
            ...
            <div class="space-y-4 text-left">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-outfit font-bold text-sm tracking-widest text-slate-900 uppercase">STOCK <span class="text-[#af8a3c]">SUMMIT UI</span></span>
                </div>
            ...
            <div class="space-y-4 text-left">
                ...
                <ul class="grid grid-cols-2 gap-2 text-xs font-light text-slate-600">
