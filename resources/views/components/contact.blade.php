<!-- Contact Us Section -->
<section id="contact" class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative border-t border-[#af8a3c]/15 mt-12 overflow-visible">
    ...
    <!-- Left Floating Decorative Elements (Outside Grid - Rame) -->
    <!-- Rings -->
    ...
    <!-- Right Floating Decorative Elements (Outside Grid - Rame) -->
    <!-- Rings -->
    ...
    <div class="text-center mb-16 space-y-3">
        ...
        <p class="text-slate-400 text-sm sm:text-base max-w-xl mx-auto">
            Have questions or need assistance? Reach out to our committee and we will get back to you shortly.
        </p>
    </div>
        ...
        <div class="flex flex-col justify-center text-left lg:pl-8 space-y-6">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-start gap-4">
                    <div class="w-11 h-11 rounded-xl bg-[#af8a3c]/15 text-[#af8a3c] flex items-center justify-center border border-[#af8a3c]/30 shrink-0">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                        </svg>
                    </div>
                    <div class="space-y-0.5">
                        <h4 class="font-outfit font-bold text-white text-base">Email Us</h4>
                        <p class="text-xs text-slate-400">For inquiries & sponsorships</p>
                        <a href="mailto:stocksummit.ui@gmail.com" class="text-sm font-semibold text-[#af8a3c] hover:underline block pt-0.5">stocksummit.ui@gmail.com</a>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                    <div class="w-11 h-11 rounded-xl bg-[#af8a3c]/15 text-[#af8a3c] flex items-center justify-center border border-[#af8a3c]/30 shrink-0">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a.598.598 0 01-.774-.774 5.974 5.974 0 011.026-3.89A7.98 7.98 0 013 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
                        </svg>
                    </div>
                    <div class="space-y-3 flex-1">
                        <h4 class="font-outfit font-bold text-white text-base">WhatsApp Support</h4>
                        <div class="flex flex-col gap-3.5">
                            <!-- Competition -->
                            <div class="space-y-0.5">
                                <span class="text-xs font-semibold text-white block">Competition</span>
                                <a href="https://wa.me/6285888009171" target="_blank" class="text-sm font-semibold text-[#af8a3c] hover:underline inline-block">
                                    +62 858-8800-9171 (Ilham)
                                </a>
                            </div>
                            
                            <!-- Media Partner -->
                            <div class="space-y-0.5">
                                <span class="text-xs font-semibold text-white block">Media Partnership</span>
                                <a href="https://wa.me/62895413976337" target="_blank" class="text-sm font-semibold text-[#af8a3c] hover:underline inline-block">
                                    +62 895-4139-76337 (Amanda)
                                </a>
                            </div>
                            
                            <!-- Sponsorship -->
                            <div class="space-y-0.5">
                                <span class="text-xs font-semibold text-white block">Sponsorship</span>
                                <a href="https://wa.me/62895364501104" target="_blank" class="text-sm font-semibold text-[#af8a3c] hover:underline inline-block">
                                    +62 895-3645-01104 (Merlinda)
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="space-y-0.5">
                        <h4 class="font-outfit font-bold text-white text-base">Secretariat Location</h4>
                        <p class="text-xs text-slate-400">Vokasi Universitas Indonesia</p>
                        <span class="text-sm font-semibold text-slate-300 block pt-0.5">Vokasi UI, Depok</span>
                    </div>
                </div>
            </div>
        </div>
