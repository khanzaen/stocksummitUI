...
<section id="archives" class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative border-t border-[#af8a3c]/15 mt-12 overflow-hidden">
    ...
    <div class="text-center mb-16 space-y-3">
        ...
        <p class="text-slate-400 text-sm sm:text-base max-w-xl mx-auto">
            Look back at the highlights, judges, speakers, and winners of our previous national summits.
        </p>
    </div>

    <!-- 2-Column Grid of Archive Cards -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
        ...
        <a href="/archive/2025" class="glassmorphism border border-slate-800/80 p-8 rounded-3xl text-left hover:border-[#af8a3c]/40 hover:shadow-[#af8a3c]/5 hover:shadow-2xl hover:scale-[1.02] transition-all duration-500 relative overflow-hidden group flex flex-col justify-between aspect-[16/9]">
            ...
            <div class="space-y-4">
                <span class="text-xs font-semibold text-[#af8a3c] uppercase tracking-widest bg-[#af8a3c]/10 px-3 py-1 rounded-full">Recap 2025</span>
                <h3 class="font-outfit font-black text-2xl sm:text-3xl text-white mt-2">Stock Summit 2025</h3>
                <p class="text-slate-400 text-xs sm:text-sm font-light">Explore highlights, winners podium, and committee structural gallery.</p>
            </div>
            
            <div class="flex items-center gap-2 text-xs sm:text-sm font-semibold text-[#af8a3c] group-hover:text-[#cba14b] transition-colors pt-4">
                Explore Event Recap
                <svg class="w-4 h-4 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
            </div>
        </a>
        ...
        <a href="/archive/2024" class="glassmorphism border border-slate-800/80 p-8 rounded-3xl text-left hover:border-[#af8a3c]/40 hover:shadow-[#af8a3c]/5 hover:shadow-2xl hover:scale-[1.02] transition-all duration-500 relative overflow-hidden group flex flex-col justify-between aspect-[16/9]">
            ...
            <div class="space-y-4">
                <span class="text-xs font-semibold text-[#af8a3c] uppercase tracking-widest bg-[#af8a3c]/10 px-3 py-1 rounded-full">Recap 2024</span>
                <h3 class="font-outfit font-black text-2xl sm:text-3xl text-white mt-2">Stock Summit 2024</h3>
                <p class="text-slate-400 text-xs sm:text-sm font-light">Look back at our very first national finance arena, keynotes, and statistics.</p>
            </div>
