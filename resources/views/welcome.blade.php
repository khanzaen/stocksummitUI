...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    ...
    <body class="bg-[#10143d] text-slate-100 font-sans antialiased overflow-x-hidden selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-indigo-500/20 rounded-full blur-[120px] -z-10"></div>
        <div class="absolute top-[800px] left-0 w-[400px] h-[400px] bg-amber-500/10 rounded-full blur-[100px] -z-10"></div>
        <div class="absolute bottom-[400px] right-10 w-[450px] h-[450px] bg-indigo-500/20 rounded-full blur-[110px] -z-10"></div>
